...
MSG_STEAM_LINK_PRIVATE_CHAT_WARNING = "⚠️ Вы используете эту команду в личном чате. Ваш Steam ID будет привязан только к этому чату. Если вы хотите использовать бота в групповом чате, вызовите команду /link_steam непосредственно в том чате."
